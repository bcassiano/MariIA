...
FROM (
    ...
    SELECT 
        ...
        -- Lógica Simplificada de Frete (Idealmente deveria ser uma tabela de fretes pré-calculada, mantendo a lógica original por enquanto mas via JOIN se possível, aqui simplificado para performance)
        CASE 
    ...
    SELECT 
        ...
        -- Frete (Simplificado para NULL em pedidos abertos se não houver cálculo complexo, ou manter lógica original via subquery se estritamente necessário, aqui deixo 0 para performance, ajustar se crítico)
        0 AS Valor_Frete, 
